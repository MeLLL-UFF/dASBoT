...
public class RuleParallel extends Thread {
    ...
    /**
     * Method to create the rules by consuming the queue of example's numbers until the queue is empty.
     ...
     * This description is an overall statics of the rules generated by this class.
    ...
    /**
     * A getter for the total time that does took to be generated the rules by this class.
